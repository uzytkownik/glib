...
const char       *g_network_address_get_ascii_name (GNetworkAddress  *addr);
...
GSockaddr        *g_sockaddr_new_from_string       (const char       *ip_addr,
						    gushort           port);
...
char             *g_sockaddr_to_string             (GSockaddr        *sockaddr);
