                ...
                GError       **error)
{
  ...
  req = g_threaded_resolver_request_new (do_lookup_by_name, cancellable);
                   ...
                   GError          **error)
{
  ...
  req = g_threaded_resolver_request_new (do_lookup_by_address, cancellable);
                ...
                GError          **error)
{
  ...
  req = g_threaded_resolver_request_new (do_lookup_service, cancellable);
