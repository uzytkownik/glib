 ...
 *
 * Enumerator interface for objects that contain or generate
 * #GSocketAddress<!-- -->es.
 **/
...
struct _GSocketAddressEnumeratorClass
{
  ...
  GSocketAddress * (* get_next)        (GSocketAddressEnumerator  *enumerator,
		  			GCancellable              *cancellable,
		  			GError                   **error);

  void             (* get_next_async)  (GSocketAddressEnumerator  *enumerator,
		  			GCancellable              *cancellable,
		  			GAsyncReadyCallback        callback,
		  			gpointer                   user_data);
  GSocketAddress * (* get_next_finish) (GSocketAddressEnumerator  *enumerator,
					GAsyncResult              *result,
					GError                   **error);
};
...
GSocketAddress *g_socket_address_enumerator_get_next        (GSocketAddressEnumerator  *enumerator,
							     GCancellable              *cancellable,
							     GError                   **error);

void            g_socket_address_enumerator_get_next_async  (GSocketAddressEnumerator  *enumerator,
							     GCancellable              *cancellable,
							     GAsyncReadyCallback        callback,
							     gpointer                   user_data);
GSocketAddress *g_socket_address_enumerator_get_next_finish (GSocketAddressEnumerator  *enumerator,
							     GAsyncResult              *result,
							     GError                   **error);
